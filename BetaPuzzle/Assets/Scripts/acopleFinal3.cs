...
public class acopleFinal3 : MonoBehaviour
{
    ...
    public GameObject[] colliders = new GameObject[8];//CAMBIA EN CADA SCRIPT
    ...
    void Start()
    {
        ...
        caraCubo = GameObject.Find("cubol3");//CAMBIA EN CADA SCRIPT
    ...
    void Update()
    {
        ...
        CaraOk = puntero.GetComponent<Puntero>().caraCorrecta[2];//para que la pieza solo pueda ponerse en su cara correspondiente        //CAMBIA EN CADA SCRIPT
    ...
    IEnumerator piezaReturn()
    {
        ...
        if (pegado)
        {
            ...
            inhabilitarPieza = GameObject.Find("pieza3");   //CAMBIA EN CADA SCRIPT!!!
            ...
            puntero.GetComponent<Puntero>().caraCorrecta[2] = false; //CAMBIA EN CADA SCRIPT !!!!
