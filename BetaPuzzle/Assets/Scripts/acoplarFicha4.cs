...
public class acoplarFicha4 : MonoBehaviour {
   ...
   void Start()
    {
        ...
        caraCubo = GameObject.Find("cubol4");
    ...
    void Update()
    {
        ...
        CaraOk = puntero.GetComponent<Puntero>().caraCorrecta[3];//para que la pieza solo pueda ponerse en su cara correspondiente
    ...
    IEnumerator piezaReturn()
    {
        ...
        if (pegado)
        {
            ...
            inhabilitarPieza = GameObject.Find("pieza4");
            ...
            puntero.GetComponent<Puntero>().caraCorrecta[3] = false;//para el selector y que no se quede abierto lo de pegar la pieza
   ...
   void CancelarAccion()
   {
      ...
      //NUEVO
      puntero.GetComponent<Puntero>().caraCorrecta[3] = false;
