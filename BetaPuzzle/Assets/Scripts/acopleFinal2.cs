...
public class acopleFinal2 : MonoBehaviour {
    ...
    public GameObject[] colliders = new GameObject[7];//CAMBIA EN CADA SCRIPT
    ...
    void Start()
    {
        ...
        caraCubo = GameObject.Find("cubol2");//CAMBIA EN CADA SCRIPT
    ...
    void Update()
    {
        ...
        CaraOk = puntero.GetComponent<Puntero>().caraCorrecta[1];//para que la pieza solo pueda ponerse en su cara correspondiente        //CAMBIA EN CADA SCRIPT
    ...
    IEnumerator piezaReturn()
    {
        ...
        if (pegado)
        {
            ...
            inhabilitarPieza = GameObject.Find("pieza2");   //CAMBIA EN CADA SCRIPT!!!
            ...
            puntero.GetComponent<Puntero>().caraCorrecta[1] = false; //CAMBIA EN CADA SCRIPT !!!!
