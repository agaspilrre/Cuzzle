...
public class pieza5 : MonoBehaviour {
   ...
   CambiarColor scrpt6;
    ...
    void Start()
    {
        ...
        scrpt = GameObject.Find("Grande5").GetComponent<moverFicha>();
        ...
        Pieza = GameObject.Find("Grande5");

        Pieza.SetActive(false);

      scrpt6 = GameObject.Find("lado5").GetComponent<CambiarColor>();
