...
public class pieza3 : MonoBehaviour {
    ...
    void Start()
    {
        ...
        scrpt = GameObject.Find("Grande3").GetComponent<moverFicha>();
        ...
        Pieza = GameObject.Find("Grande3");

        Pieza.SetActive(false);

        acertada = false;

        scrpt6 = GameObject.Find("lado3").GetComponent<CambiarColor>();
