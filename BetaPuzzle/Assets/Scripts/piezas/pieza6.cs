...
public class pieza6 : MonoBehaviour {
    ...
    void Start()
    {
        ...
        scrpt = GameObject.Find("Grande6").GetComponent<moverFicha>();
        ...
        Pieza = GameObject.Find("Grande6");

        acertada = false;

        Pieza.SetActive(false);

      scrpt6 = GameObject.Find("lado6").GetComponent<CambiarColor>();
