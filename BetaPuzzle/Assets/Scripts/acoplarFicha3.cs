...
public class acoplarFicha3 : MonoBehaviour {
   ...
   Vector3 posicionRetorno;
    ...
    void Start()
    {
        ...
        caraCubo = GameObject.Find("cubol3");
    ...
    void Update()
    {
        ...
        CaraOk = puntero.GetComponent<Puntero>().caraCorrecta[2];//para que la pieza solo pueda ponerse en su cara correspondiente
    ...
    IEnumerator piezaReturn()
    {
        ...
        if (pegado)
        {
            ...
            inhabilitarPieza = GameObject.Find("pieza3");
            ...
            puntero.GetComponent<Puntero>().caraCorrecta[2] = false;//para el selector y que no se quede abierto lo de pegar la pieza
   ...
   void CancelarAccion()
   {
      ...
      //NUEVO
      puntero.GetComponent<Puntero>().caraCorrecta[2] = false;
