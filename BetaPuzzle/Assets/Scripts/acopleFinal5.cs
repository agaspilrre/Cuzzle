...
public class acopleFinal5 : MonoBehaviour {
    ...
    void Start()
    {
        ...
        caraCubo = GameObject.Find("cubol5");//CAMBIA EN CADA SCRIPT
    ...
    void Update()
    {
        ...
        CaraOk = puntero.GetComponent<Puntero>().caraCorrecta[4];//para que la pieza solo pueda ponerse en su cara correspondiente        //CAMBIA EN CADA SCRIPT
    ...
    IEnumerator piezaReturn()
    {
        ...
        if (pegado)
        {
            ...
            inhabilitarPieza = GameObject.Find("pieza5");   //CAMBIA EN CADA SCRIPT!!!
            ...
            puntero.GetComponent<Puntero>().caraCorrecta[4] = false; //CAMBIA EN CADA SCRIPT !!!!
