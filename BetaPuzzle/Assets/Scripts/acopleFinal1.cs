...
public class acopleFinal1 : MonoBehaviour {
    ...
    public GameObject[] colliders=new GameObject[6];
    ...
    void Start()
    {
        ...
        caraCubo = GameObject.Find("cubol1");
        puntero = GameObject.Find("Selector");
        GuardoPiezaAcoplada = GameObject.Find("GameManager");//PRUEBAAAAA
    ...
    void Update()
    {
        ...
        CaraOk = puntero.GetComponent<Puntero>().caraCorrecta[0];//para que la pieza solo pueda ponerse en su cara correspondiente
    ...
    IEnumerator piezaReturn()
    {
        ...
        if (pegado)
        {
            ...
            inhabilitarPieza = GameObject.Find("pieza1");
            ...
            puntero.GetComponent<Puntero>().caraCorrecta[0] = false;
            ...
            GuardoPiezaAcoplada.GetComponent<retrocederMontaje>().Añadirpieza(this.gameObject);//PRUEBAAAAAAAAAAA
        ...
        else
        {
            ...
            GetComponent<moverFicha>().SetPermitido(true);//CORRECION BUG DE ROTACION AL ACOPLAR LA PIEZA
   ...
   public  void CancelarAccion()
    {
        ...
        GetComponent<moverFicha>().SetPermitido(true);

        habilitarCubo.GetComponent<Girar>().SetPermitido(false);//no  podemos mover el cubo
