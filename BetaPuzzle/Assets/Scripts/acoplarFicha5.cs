...
public class acoplarFicha5 : MonoBehaviour {
   ...
   void Start()
    {
        ...
        caraCubo = GameObject.Find("cubol5");
    ...
    void Update()
    {
        ...
        CaraOk = puntero.GetComponent<Puntero>().caraCorrecta[4];//para que la pieza solo pueda ponerse en su cara correspondiente
    ...
    IEnumerator piezaReturn()
    {
        ...
        if (pegado)
        {
            ...
            inhabilitarPieza = GameObject.Find("pieza5");
            ...
            puntero.GetComponent<Puntero>().caraCorrecta[4] = false;//para el selector y que no se quede abierto lo de pegar la pieza
   ...
   void CancelarAccion()
   {
      ...
      //NUEVO
      puntero.GetComponent<Puntero>().caraCorrecta[4] = false;
